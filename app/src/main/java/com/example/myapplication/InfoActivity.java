...
public class InfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (check==true) {
            ...
            Toast.makeText(InfoActivity.this,  "The text will be " + textinfo, Toast.LENGTH_SHORT).show();
        ...
        img.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                PopupMenu popupMenu = new PopupMenu(InfoActivity.this, img);
                ...
                popupMenu.setOnMenuItemClickListener(new PopupMenu.OnMenuItemClickListener() {
                    ...
                    public boolean onMenuItemClick(MenuItem menuItem) {
                        ...
                        Toast.makeText(InfoActivity.this,  "You Clicked " + menuItem.getTitle(), Toast.LENGTH_SHORT).show();
                        ...
                        switch (menuItem.getItemId()) {
                            case R.id.item1:
                                ...
                                break;
                            case R.id.item2:
                                Intent intent2 = new Intent(InfoActivity.this, InfoActivity.class);
                                startActivity(intent2);
                                break;
                            case R.id.item3:
                                Intent intent3 = new Intent(InfoActivity.this, PrescriptionActivity.class);
                                startActivity(intent3);
                                break;
                            case R.id.item4:
                                Intent intent4 = new Intent(InfoActivity.this, AppointmentActivity.class);
                                startActivity(intent4);
                                break;
                            case R.id.item5:
                                Intent intent5 = new Intent(InfoActivity.this, RecordsActivity.class);
                                startActivity(intent5);
                                break;
                            default:
                                Toast.makeText(InfoActivity.this, "It has entered the loop", Toast.LENGTH_SHORT).show();
                        }
